...
chmod +x run-demo.sh run-demo-full.sh issue-sidecar.sh collaboration_demo.py serve-ui.sh install.sh
...
echo "MCP config:  ./install.sh  (prints VITASIDE_MANIFEST) or edit mcp-config.example.json"
echo "Release:     docs/RELEASE.md"
echo ""
